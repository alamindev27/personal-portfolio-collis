<?php require_once 'inc/header.php';
  $select = "SELECT * FROM portfolios INNER JOIN category ON portfolios.cate_id = category.cat_id WHERE status = 1";
            ...
            <?php foreach ($query as $key => $portfolio): ?>
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="edit-portfolio.php?id=<?= $portfolio['id'] ?>" class="btn  btn-secondary">Edit</a><br><br>
                  <a href="delete-portfolio.php?id=<?= $portfolio['id'] ?>" class="btn  btn-danger">Delete</a>
                </td>
              </tr>
            <?php endforeach ?>     
            </tbody>
