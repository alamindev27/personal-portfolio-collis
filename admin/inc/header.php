...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>FMA<span>]</span></a></div>
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-hero.php" class="nav-link">View hero</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="hero.php" class="nav-link">Add hero Text</a>
          </li>
        </ul>
         <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Welcome</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-welcome.php" class="nav-link">View Wellcome</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-welcome.php" class="nav-link">Add Wellcome</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-welcome.php" class="nav-link">Trash Welcome</a>
          </li>
        </ul>
         <a href="#" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-social.php" class="nav-link">View Social</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-social.php" class="nav-link">Add Social</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-social.php" class="nav-link">Trash Social</a>
          </li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-about.php" class="nav-link">View About</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-about.php" class="nav-link">Add About</a>
          </li>
        </ul>
         ...
         <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Progress Skill</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-progress.php" class="nav-link">View Progress</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-progress.php" class="nav-link">Add Progress</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-progress.php" class="nav-link">Trash Progress</a>
          </li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-services.php" class="nav-link">View Services</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-services.php" class="nav-link">Add Services</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-services.php" class="nav-link">Trash Services</a>
          </li>
        </ul>
         ...
         <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Counterup</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-counterup.php" class="nav-link">View Counterup</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-counterup.php" class="nav-link">Add Counterup</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-counterup.php" class="nav-link">Trash Counterup</a>
          </li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-portfolio.php" class="nav-link">View Portfolios</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-portfolio.php" class="nav-link">Add Portfolios</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-portfolio.php" class="nav-link">Trash Portfolios</a>
          </li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-testimonials.php" class="nav-link">View Testimonials</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="add-testimonials.php" class="nav-link">Add Testimonials</a>
          </li>
          <li class="nav-item text-capitalize">
            <a href="trash-testimonials.php" class="nav-link">Trash Testimonials</a>
          </li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item text-capitalize">
            <a href="view-mail.php" class="nav-link">View Mail</a>
          </li>
        </ul>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link pd-x-7 pos-relative" data-toggle="dropdown">
              ...
              <!-- start: if statement -->
              <?php 
              $not = "SELECT * FROM mail WHERE notification = 'on'";
              $nq = mysqli_query($conn, $not);
              $na = mysqli_fetch_assoc($nq);
               ?>
              <span class="square-8 <?= isset($na['notification']) == 'on' ? 'bg-danger' : '' ?> pos-absolute t-15 r-0 rounded-circle"></span>
              <!-- end: if statement -->
            </a>
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?= $assoc['name'] ?></span>
              <img src="upload/profile/<?= $assoc['image'] ?>" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="edit-profile.php?admin=<?= $assoc['id'] ?>"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
