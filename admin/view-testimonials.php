<?php require_once 'inc/header.php';
  $select = "SELECT * FROM Testimonials WHERE status = 1";
 ...
 <table class="table table-bordered table-colored table-primary">
            ...
            <?php foreach ($query as $key => $testimonials): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="edit-testimonials.php?id= <?= $testimonials['id'] ?>" class="btn  btn-secondary">Edit</a><br><br>
                  <a href="delete-testimonials.php?id= <?= $testimonials['id'] ?>" class="btn  btn-danger">Delete</a>
                </td>
              </tr>
            <?php endforeach ?>     
            </tbody>
